...
export default function LoginScreen({ navigation }) {
  ...
  async function handleLogin() {
    ...
    setLoading(true);
    // مؤقتًا: دخول مباشر بدون رمز تحقق (لحين تفعيل مزود SMS الفعلي لاحقًا)
    // ملاحظة: هذا ينشئ جلسة جديدة كل مرة، مو ربط فعلي برقم الجوال بعد — يحتاج OTP الحقيقي لهذا الغرض
